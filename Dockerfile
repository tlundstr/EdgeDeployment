...
RUN /opt/softwareag/wpm/bin/wpm.sh install -u tlundstr -p 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 -d /opt/softwareag/IntegrationServer -r https://github.com/tlundstr T2Utilities
