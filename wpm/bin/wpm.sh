...
CLASSPATH=$CLASSPATH:$WPM_CLIENT_HOME/lib/is-wpm-client.jar
...
CLASSPATH=$CLASSPATH:$WPM_CLIENT_HOME/lib/jackson-databind.jar
CLASSPATH=$CLASSPATH:$WPM_CLIENT_HOME/lib/jackson-annotations.jar
